...
const CreateGroup = () => {
  ...
  const onFinish = async (values) => {
    ...
    try {
      ...
      let groupList = Array.isArray(groupsRes.data)
        ? groupsRes.data
        : groupsRes.data?.data || [];
          ...
          <Card className="create-group-card" bordered={false}>
            <div className="create-group-header">
              ...
              <p className="create-group-subtitle">
                Start a new co-ownership group to manage shared resources and
                vehicles
              </p>
            </div>
            ...
            <div className="create-group-body">
              <div className="create-group-info-box">
                <h4>
                  <InfoCircleOutlined /> What is a Co-ownership Group?
                </h4>
                <p>
                  A group allows multiple members to share ownership and usage
                  of electric vehicles, reducing costs and promoting sustainable
                  transportation.
                </p>
              </div>
