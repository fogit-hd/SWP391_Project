...
import { CalendarOutlined, PlusOutlined, ReloadOutlined, CarOutlined } from "@ant-design/icons";
...
const BookingCalendar = () => {
  ...
  // Reload bookings when refreshKey changes
  useEffect(() => {
    if (selectedGroupId && selectedVehicleId) {
      fetchBookings();
    }
  }, [refreshKey, selectedGroupId, selectedVehicleId]);
